...
//////////////////////////////////////////////////////////////////////////
void Accelerometer::Print_Everything(){   //For Debugging purposes/////////////
   Serial.println("start");
   Serial.print(accel[3]);  // Actually stores the NEGATED acceleration (equals gravity, if board not moving).
//   float accel_min[3];
//   float accel_max[3];
//
//   float magnetom[3];
