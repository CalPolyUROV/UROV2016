...
void output_angles()
{
  ...
  {
    //Serial.print("#YPR="); //Old output method
//    Serial.print("YPR=");
//    Serial.print(TO_DEG(yaw)); Serial.print(",");
//    Serial.print(TO_DEG(pitch)); Serial.print(",");
//    Serial.print(TO_DEG(roll)); Serial.println();
//    Serial.print("YAW");
//    Serial.println(TO_DEG(yaw)); //Serial.print(",");
//    Serial.print("PCH");
//    Serial.println(TO_DEG(pitch)); //Serial.print(",");
//    Serial.print("ROL");
//    Serial.println(TO_DEG(roll)); //Serial.println();


//
//    Serial.println("YPR"); //tell it the next line is Accelerometer
//    Serial.print(" YPR: Y: ");
